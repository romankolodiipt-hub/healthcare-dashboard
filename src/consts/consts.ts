import { DiagnosticTableHeader, Patient } from "../types/types";

export const DIAGNOSTIC_TABLE_HEADERS: DiagnosticTableHeader = [
  "Problem/Diagnosis",
  "Description",
  "Status",
];

export const MOCK_DATA_PATIENTS: Patient[] = [
  {
    name: "Emily Williams",
    gender: "Female",
    age: 18,
